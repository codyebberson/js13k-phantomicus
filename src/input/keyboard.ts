...
export const keys = new InputSet(256);
...
/**
 * Returns if the key is pressed this frame.
 * This is useful for checking if a key was pressed once.
 * @param keyCode
 * @returns
 */
export const isKeyPressed = (keyCode: number): boolean => keys.get(keyCode).downCount === 1;
